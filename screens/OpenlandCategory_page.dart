...
class OLCategoryPage extends StatelessWidget {
  final CategoryModel categoryModel;
  const OLCategoryPage({
    Key? key,
            ...
            child: Column(
              children: [
                ...
                ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: openLandProperties.length,
                  itemBuilder: (BuildContext context, int index) {
                    return ExpandedRecommendationCardOL(
                      propertyModel: openLandProperties[index],
                    );
                  },
                )
...
class ExpandedRecommendationCardOL extends StatelessWidget {
  const ExpandedRecommendationCardOL({
    Key? key,
