...
import 'contactpropManager.dart';
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Managed by: ${portfoliopropertyModel.propman.name}",
                        style: const TextStyle( color: Colors.black,
                            fontWeight: FontWeight.bold,
                            fontSize: 20
                        ),
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => ContactPropMan(portfolioproperty: portfoliopropertyModel)),
                        );
                      },
                      child: Container(
    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: widget.portfoliopropertyModel.images.asMap().entries.map((entry) {
