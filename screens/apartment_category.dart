...
class ApartCategoryPage extends StatelessWidget {
  final CategoryModel categoryModel;
  const ApartCategoryPage({
    Key? key,
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return ExpandedRecommendationCardA(
                      propertyModel: apartmentProperties[index],
                    );
                  },
                )
...
class ExpandedRecommendationCardA extends StatelessWidget {
  const ExpandedRecommendationCardA({
    Key? key,
